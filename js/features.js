...
,
  {kw:["кто ты","как тебя зовут","твое имя","что ты","ты кто","имя"],
   answer:"Меня зовут <b>Помощник «Гармония»</b>! Я виртуальный помощник центра «Гармония». Помогу найти услуги, записаться к специалисту и ответить на вопросы. ",
   actions:[]},
  {kw:["спасиб","благодар","молодец","класс","супер","круто","отлично"],
   answer:"Рад помочь! 😊 Если будут ещё вопросы — обращайтесь, Помощник «Гармония» всегда на связи!",
   actions:[]},
  {kw:["не работает","ошибк","баг","глюч","сломал","проблем"],
   answer:"Попробуйте обновить страницу. Если проблема повторяется — свяжитесь с оператором, вам помогут!",
   actions:[{label:"💬 Написать оператору",fn:"showLiveChat",cl:"blue"}]},
  {kw:["скидк","дешевл","акци","бесплатн","льгот","скольк стоит","цен"],
   answer:"Проверьте право на бесплатное обслуживание в калькуляторе льгот. А карта «Морошка» даёт скидку на все платные услуги!",
   actions:[{label:"🧮 Калькулятор льгот",fn:"showEligibility",cl:"green"},{label:"📋 Прейскурант",fn:"showServices",cl:"teal"}]},
  {kw:["график","часы работы","режим","когда открыт","когда работа","рабочее время"],
   answer:"Центр работает Пн–Пт с 08:30 до 18:00. В выходные и праздничные дни — выходной.",
   actions:[{label:"📍 Контакты",fn:"showContacts",cl:"teal"}]},
  {kw:["где находи","адрес","как добрат","как доехат","как пройти","карт","маршрут"],
   answer:"Адрес и контакты филиала в вашем городе — в разделе «Контакты».",
   actions:[{label:"📍 Контакты",fn:"showContacts",cl:"teal"}]},
  {kw:["жалоб","претенз","недоволен","плохо обслужи","нагруби"],
   answer:"Мне очень жаль, что у вас был негативный опыт. Вы можете оставить обращение — его рассмотрит руководство.",
   actions:[{label:"💬 Обратная связь",fn:"showFeedback",cl:"green"},{label:"💬 Написать оператору",fn:"showLiveChat",cl:"blue"}]},
  {kw:["инвалид","огранич","доступн","коляск","слабовид","слабослыш"],
   answer:"Наш центр обеспечивает доступную среду. Для получателей с инвалидностью предусмотрены специальные условия. Обратитесь к специалисту для подбора индивидуальной программы.",
   actions:[{label:"📞 Обратный звонок",fn:"showCallback",cl:"gold"},{label:"🏠 Соцработник на дом",fn:"showHomeWorker",cl:"teal"}]},
  {kw:["ребен","дет","семь","многодет","мать","отец","родител","несовершеннолет","подрост"],
   answer:"Для семей с детьми работает отделение профилактики безнадзорности. Есть программы реабилитации, социальный педагог и психолог.",
   actions:[{label:"👥 Сотрудники",fn:"showStaff",cl:"green"},{label:"🎟️ Мероприятия",fn:"showEvents",cl:"blue"}]},
  {kw:["пожил","старш","пенсион","долголет","ветеран","дедушк","бабушк"],
   answer:"Для граждан старшего возраста работает отделение активного долголетия и служба социального обслуживания на дому.",
   actions:[{label:"🏠 Соцработник на дом",fn:"showHomeWorker",cl:"teal"},{label:"📋 Все услуги",fn:"showServices",cl:"teal"}]},
  {kw:["психолог","депресс","тревог","страх","стресс","тяжело","плохо себя чувств"],
   answer:"В нашем центре работают квалифицированные психологи. Можно записаться на приём или позвонить на линию экстренной помощи.",
   actions:[{label:"🆘 Экстренная помощь",fn:"showEmergency",cl:"red"},{label:"📝 Записаться",fn:"showBooking",cl:"gold"}]},
  {kw:["логопед","речь","заикан","развити"],
   answer:"В отделении комплексной реабилитации работает логопед. Запишитесь на приём через раздел «Записаться».",
   actions:[{label:"📝 Записаться",fn:"showBooking",cl:"gold"}]},
  {kw:["реабилитац","восстановлен","массаж","лфк","физиотерап"],
   answer:"Отделение комплексной реабилитации предоставляет широкий спектр услуг: от массажа до занятий с психологом и логопедом.",
   actions:[{label:"📋 Все услуги",fn:"showServices",cl:"teal"},{label:"📝 Записаться",fn:"showBooking",cl:"gold"}]},
  {kw:["морошк","карт","единая карта","карта жителя"],
   answer:"Карта «Морошка» — единая карта жителя ЯНАО. Даёт скидку на все платные услуги центра. Оформить можно в МФЦ.",
   actions:[{label:"🍊 Подробнее",fn:"showMoroshkaInfo",cl:"gold"}]}];
...
function smallTalk(q){
  ...
  if(/помощник/i.test(ql))return{text:"Да, это я — Помощник «Гармония»!  Чем могу помочь?",actions:[]};
  if(/молодец|умница|красав/i.test(ql))return{text:"Спасибо! Стараюсь для вас! 😊",actions:[]};
  if(/пока|до свидан|прощай|уход/i.test(ql))return{text:"До свидания! Буду рад помочь снова. Хорошего дня! 👋",actions:[]};
  if(/как дела|как ты|как жизнь|как поживаешь/i.test(ql))return{text:"У меня всё отлично, спасибо! Работаю для вас круглосуточно 😊 Чем могу помочь?",actions:[]};
