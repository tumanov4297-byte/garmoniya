...
function showAssistant(){
  ...
  const nm=asstName();
  addMsg(`<div class="asst-live"><video src="img/bot-live.mp4" poster="img/bot-live-poster.jpg" autoplay muted loop playsinline disablepictureinpicture></video></div>Здравствуйте${nm?", "+nm:""}! 👋 Я помощник «Гармонии». Теперь я умею записывать сразу к нужному специалисту: скажите, например, «запиши меня к психологу», «нужен логопед», «хочу в соляную комнату» или «оформить 3-НДФЛ» — и я открою запись по этому направлению.`,true);
  setTimeout(()=>{
    clearActions();
